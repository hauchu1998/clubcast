...
export interface ClubCastGovernorInterface extends utils.Interface {
  functions: {
...
export interface ClubCastGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClubCastGovernorInterface;
